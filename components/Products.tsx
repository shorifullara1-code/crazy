...
import { CheckCircle2, GraduationCap, LayoutDashboard, Smartphone, ShieldCheck } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2 w-full">
            <div className="grid grid-cols-2 gap-4">
               {/* Feature Cards Grid */}
               <StaggerContainer className="space-y-4 mt-8" staggerDelay={0.2}>
                 <StaggerItem className="bg-slate-800 p-6 rounded-2xl border border-slate-700 hover:border-brand-accent transition-all hover:translate-x-1">
